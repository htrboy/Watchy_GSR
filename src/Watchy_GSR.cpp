...
void WatchyGSR::init(String datetime){
    ...
    if (!i2cIsInit) {Wire.begin(SDA, SCL);} //init i2c
    NVS.begin();
...
void WatchyGSR::initWatchFaceStyle(){
    ...
    switch (Style){
      case 1: // Ballsy
          ...
          Design.Face.TimeColor = (BackColor() == GxEPD_WHITE) ? GxEPD_BLACK : GxEPD_WHITE; // GxEPD_BLACK
          ...
          Design.Face.DayColor = (BackColor() == GxEPD_WHITE) ? GxEPD_BLACK : GxEPD_WHITE; // GxEPD_BLACK
          ...
          Design.Face.DateColor = (BackColor() == GxEPD_WHITE) ? GxEPD_BLACK : GxEPD_WHITE; // GxEPD_BLACK
          ...
          Design.Face.YearColor = (BackColor() == GxEPD_WHITE) ? GxEPD_BLACK : GxEPD_WHITE; // GxEPD_BLACK
